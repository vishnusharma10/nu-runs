...
const EnrolledChallengeCard = ({challenge,distance,challengeType,id}) => {
    const submitActivity = async(userId, challengeId)=>{
      ...
      <div class="col-md-6 col-lg-4" style={{display:"inline-block",textAlign:"center"}}>
        <div>
          <div class="speaker">
            ...
            <button onClick={()=>submitActivity(userId,id)}>Submit Data</button>
          </div>
        </div>
      </div>
    </>
...
export default EnrolledChallengeCard;